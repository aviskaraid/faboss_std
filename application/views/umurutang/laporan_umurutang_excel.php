...
$sheet->setCellValue('A2', 'Laporan Umur Hutang');
...
$sheet->setTitle("Laporan Umur Hutang");

$writer = new Xls($spreadsheet); // instantiate Xlsx
 
$filename = time().'_laporan_umur_hutang'; // set filename for excel file to be exported
