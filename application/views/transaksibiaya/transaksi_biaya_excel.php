...
$sheet->setCellValue('A2', 'Laporan Transaksi Biaya'); // Set kolom A1 dengan tulisan "DATA SISWA"
...
$sheet->setCellValue('E5', "Akun Biaya");
...
if (!empty($dbAll))
{
    ...
    foreach ($dbAll as $row)
    {
          ...
          $sheet->setCellValue('E'.$numrow, $row['nm_biaya']);
...
$sheet->setTitle("Laporan Transaksi Biaya");

// instantiate Xlsx
$writer = new Xlsx($spreadsheet);

$filename = time().'_laporan_transaksi_biaya.xlsx';
