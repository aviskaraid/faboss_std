  ...
  <div class="row">
  	<div class="col-lg">
		...
		<?= $this->session->flashdata('message'); ?>
  		...
  		<a href="<?= base_url('menu/') ?>" class="btn btn-secondary mb-3">Kembali</a>
  		<div class="table-responsive">
	  		<table class="table table-submenu table-hover table-sm" id="tabel-data">
			  <thead>
			    <tr>
			      <th scope="col">#</th>
			  ...
			  <tbody>
			    ...
			    <tr>
			      ...
			      <td><?= $sm['menu']; ?></td>
			      <td><?= $sm['url']; ?></td>
			      <td><?= ($sm['is_active'] == 1) ? "Aktif" : "NonAktif"; ?></td>
			      <td>
...
<div class="modal fade" id="newSubMenuModal" tabindex="-1" role="dialog" aria-labelledby="newSubMenuModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('menu/submenu/'.$menu['id']); ?>" method="post">
