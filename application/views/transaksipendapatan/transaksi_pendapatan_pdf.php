...
class PDF extends PDF_MC_Table{
    ...
    function Content($dbAll, $tglAwal, $tglAkhir, $profile){
        if ($this->PageNo() == 1){
            ...
            $this->cell(0,6,'Laporan Transaksi Pendapatan',0,1,'C',1); 
            ...
            $this->cell(30,6,'Akun Pendapatan',1,0,'C',1);
...
$pdf->AliasNbPages();
$pdf->AddPage();
$pdf->setTitle('Laporan Transaksi Pendapatan '.$profile['name'],true);
$pdf->Content($dbAll, $tglAwal, $tglAkhir, $profile);
$pdf->Output('laporan-transaksi-pendapatan['.date('d-M-Y').'].pdf', 'I');
